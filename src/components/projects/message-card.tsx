...
import { E0Mark } from "@/components/brand/e0-logo";
...
function UserMessage({ content }: { content: string }) {
  return (
    <div className="flex justify-end pb-4 pl-10 pr-2">
      <Card className="max-w-[80%] wrap-break-word rounded-lg border-none bg-muted p-2 shadow-none">
        {content}
      </Card>
    </div>
  );
 ...
 *
 * Shows the e0 mark, a hover-revealed timestamp, the markdown response, and —
  ...
  return (
    ...
    >
      <div className="mb-2 flex items-center gap-2 pl-2">
        <E0Mark className="h-7 w-auto shrink-0" />
